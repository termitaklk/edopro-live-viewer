...
export type SpectatorEvent =
  ...
  | { type: "TYPE_CHANGE"; raw: number; isHost: boolean; position: number }
  | { type: "CHAT_2"; chatType: number; isTeam: boolean; clientName: string; message: string }
  | { type: "STOC_ERROR_MSG"; raw: Buffer }
  ...
  | { type: "MSG_CHAINING"; code: number; card: CardLocation; trigger: CardLocation; descriptionController: number; description: number; chainSize: number }
  | { type: "MSG_CHAINED"; chainSize: number }
  | { type: "MSG_CHAIN_SOLVING"; chainSize: number }
  | { type: "MSG_CHAIN_SOLVED"; chainSize: number }
  | { type: "MSG_CHAIN_END" }
  | { type: "MSG_DRAW"; player: number; count: number; codes: number[] }
  ...
  | { type: "UNKNOWN_STOC"; id: number; raw: Buffer }
  | { type: "UNKNOWN_MSG"; id: number; raw: Buffer };
